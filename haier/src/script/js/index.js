    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each($obj.bingxiang, function (i, n) {
                $('.bx_box .pro_box').append('<li><a href="#"><img src="' + n.url + '"><h4>' + n.title + '</h4><strong>' + n.price + '</strong></a></li>');
            })
            $.each($obj.good, function (i, n) {
                $('.kt_box .pro_box').append('<li><a href="#"><img src="' + n.url + '"><h4>' + n.title + '</h4><strong>' + n.price + '</strong></a></li>');
            })
            $.each($obj.xiyiji, function (i, n) {
                $('.xyj_box .pro_box').append('<li><a href="#"><img src="' + n.url + '"><h4>' + n.title + '</h4><strong>' + n.price + '</strong></a></li>');
            })
            //精品推荐
            ...
            //优品专辑
            $.each($obj.good, function (i, n) {
                $('.kongtiao .good_list').append('<li><a href="#"><img src="' + n.url + '"></a><h4><a href="#">' + n.title + '</a></h4><strong>' + n.price + '</strong></li>');
            })
            $.each($obj.lenggui, function (i, n) {
                $('.lenggui .good_list').append('<li><a href="#"><img src="' + n.url + '"></a><h4><a href="#">' + n.title + '</a></h4><strong>' + n.price + '</strong></li>');
            })
            $.each($obj.bingxiang, function (i, n) {
                $('.bingxiang .good_list').append('<li><a href="#"><img src="' + n.url + '"></a><h4><a href="#">' + n.title + '</a></h4><strong>' + n.price + '</strong></li>');
            })
            $.each($obj.xiyiji, function (i, n) {
                $('.xiyiji .good_list').append('<li><a href="#"><img src="' + n.url + '"></a><h4><a href="#">' + n.title + '</a></h4><strong>' + n.price + '</strong></li>');
            })
